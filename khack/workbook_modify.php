...
$ret = mysqli_query($conn, "update workbook set title ='$workbook_title', difficulty ='$workbook_difficulty' where id = '$workbook_id'");
...
foreach ($_POST['array'] as $key => $value) {
	...
	$sql .= "UPDATE workbook_problem set problem_id ='$value' where  NO='$key' and workbook_id ='$workbook_id';";
